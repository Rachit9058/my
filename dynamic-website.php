...
<head>
    ...
    <!-- Title -->
    <title>Vytalix Tech | Dynamic Website Design</title>
                    ...
                    <div class="col-lg-6">
                        <div class="responsive-design-content rmb-65 wow fadeInLeft delay-0-2s">
                            <div class="section-title">
                                <span class="sub-title style-two">Dynamic Website Design</span>
                                <h2>Transform Your Online Presence with Dynamic Websites</h2>
                            </div>
                            <p>Vytalix Tech’s dynamic website designs enable real-time content management and
                                interaction, perfect for e-commerce, blogs, and businesses with frequent updates. Stay
                                ahead with a responsive and customizable website.</p>
