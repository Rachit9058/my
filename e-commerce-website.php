...
<head>
    ...
    <!-- Title -->
    <title>Vytalix Tech | eCommerce and Product Selling Development</title>
                ...
                <div class="row large-gap align-items-center">
                    <div class="col-lg-6">
                        <div class="responsive-design-content rmb-65 wow fadeInLeft delay-0-2s">
                            <div class="section-title">
                                <span class="sub-title style-two">E-Commerce Website Design</span>
                                <h2>Boost Your Sales with a Custom E-Commerce Website</h2>
                            </div>
                            <p>Vytalix Tech provides custom e-commerce website design services to help you grow your
                                online business. From product showcasing to checkout processes, we ensure your store is
                                optimized for user engagement and sales.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="responsive-design-image wow fadeInRight delay-0-2s">
                            <img src="assets/images/services/service-four3.png" alt="Responsive Design">
                        </div>
                    </div>
                </div>
            </div>
