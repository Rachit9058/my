            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5 align-self-end">
                        <div class="hero-images mt-45 wow fadeInRight delay-0-2s">
                ...
                <div class="testimonial-two-active">
                    <div class="testimonial-item-two wow fadeInUp delay-0-2s">
                        ...
                        <div class="testimonial-content">
                            <p>Sit amet consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore dolore magna aliuasum susendise ultrices</p>
                            <div class="author-description">
                                <span class="h5">Jonathan B. Bohnert</span>
                    ...
                    <div class="testimonial-item-two wow fadeInUp delay-0-4s">
                        ...
                        <div class="testimonial-content">
                            <p>Quis autem vel eum iure reprehe nderitue voluptate esseuam nihile molestias equatur veillum dolorem eum voluptas nulla</p>
                            <div class="author-description">
                                <span class="h5">Richard V. Dillingham</span>
               ...
               <div class="section-title text-center mb-50">
                ...
                <div class="tech-features">
                    ...
                    <div class="feature">
                        <div class="feature-item wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/features/php.png" alt="Logo">
                            </div>
                            <h5>Php</h5>
                        </div>
                    </div>
                    <div class="feature">
                        <div class="feature-item wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/features/laravel.png" alt="Logo">
                            </div>
                            <h5>Laravel</h5>
                        </div>
                    </div>
                    <div class="feature">
                        <div class="feature-item wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/features/shopify.png" alt="Logo">
                            </div>
                            <h5>Shopify</h5>
                        </div>
                    </div>
                    ...
                    <div class="feature">
                        <div class="feature-item wow fadeInUp delay-0-2s">
                            <div class="image">
                                <img src="assets/images/features/node.png" alt="Logo">
                            </div>
                            <h5>Node Js</h5>
                        </div>
                    </div>
