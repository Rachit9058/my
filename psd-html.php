...
<head>
    ...
    <!-- Title -->
    <title>Vytalix Tech | Website Creation from Figma, XD or Photoshop</title>
                ...
                <div class="row large-gap align-items-center">
                    <div class="col-lg-6">
                        <div class="responsive-design-content rmb-65 wow fadeInLeft delay-0-2s">
                            <div class="section-title">
                                <span class="sub-title style-two">PSD to HTML Design</span>
                                <h2>Professional PSD to HTML Conversion Services</h2>
                            </div>
                            <p>Vytalix Tech offers expert PSD to HTML conversion, delivering pixel-perfect, responsive
                                websites. We ensure that your design is translated into clean, optimized code for fast
                                loading and cross-browser compatibility.</p>
                    ...
                    <div class="col-lg-6">
                        <div class="responsive-design-image wow fadeInRight delay-0-2s">
                            <img src="assets/images/services/service-four1.png" alt="Responsive Design">
                        </div>
                    </div>
                </div>
            </div>
